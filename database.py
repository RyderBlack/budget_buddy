...
try:
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS bank_account (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, account_name VARCHAR(255) NOT NULL, id_user INT, account_balance DECIMAL NOT NULL, FOREIGN KEY (id_user) REFERENCES user(id))")
