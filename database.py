...
try:
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS bank_account (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, id_user INT, account_balance DECIMAL NOT NULL, FOREIGN KEY (id_user) REFERENCES user(id))")
